...
from . import claude_cli, codex_cli, zhipuai_sdk
...
ADAPTERS = {"claude": claude_cli, "codex": codex_cli, "zhipuai": zhipuai_sdk}

__all__ = [
    "AdapterRequest", "ParsedResult", "build_observation", "resolve_parse_status", "run_subprocess",
    "parse_claude", "parse_codex", "parse_zhipuai", "ADAPTERS",
    "claude_cli", "codex_cli", "zhipuai_sdk",
]
