...
- **Step 4 — Quality gate: design critique.** Full 3-judge panel + opt-in adversarial-on-design (or `/reflexion:reflect` in the lane); the breaker runs EXACTLY once. (read references/steps.md §4 before executing)
