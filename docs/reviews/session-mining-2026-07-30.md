...
**Not filed — proposal only, per the approval rule.** Seven children, derived from §10 with the owner's amendments:
...
Either way the sequencing is the same: #756's high five first (#735, #733, #726, #731, #732); P1–P4/P7 can start in parallel any time; P5 waits on #735; P6 waits on the pane-handoff trio. Decision belongs to the owner at filing time.
